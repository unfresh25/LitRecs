...
In this case, we do not display the description in the table due to the space this column can occupy. However, it is a very relevant piece of data for us, so we should always collect it whenever possible.
